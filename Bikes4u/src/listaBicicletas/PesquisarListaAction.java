...
@WebServlet(urlPatterns={"/PesquisarLista"})
public class PesquisarListaAction extends HttpServlet{

  public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, java.io.IOException{

    String pesq = req.getParameter("textoPesquisa");
    ListaBicicletasDAO dao = new ListaBicicletasDAO();
    List<Bicicleta> listaBiclas = dao.getAllBicicletasPesquisa(pesq);
