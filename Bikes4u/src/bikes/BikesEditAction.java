...
/**
 * Servlet implementation class BikesEditAction
 */
@WebServlet("/BikesEditAction")
public class BikesEditAction extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      //Form fields
      String imagem = null, nome = null, idCat = null, idEst = null, idBic = null, imagemAntiga = null;
      ...
      if (!isMultipart) System.out.println("File Not Uploaded!");
        ...
        while (itr.hasNext()) {
          ...
          if (item.isFormField()){
            ...
            else if (name.equals("id")) idBic = item.getString();
            else if (name.equals("estado")) idEst = item.getString();
            else if (name.equals("fotoAntiga")) imagemAntiga = item.getString();
      ...
      System.out.println(imagemAntiga);
      if (!imagem.isEmpty()) bicla.setFoto(imagem);
      else if(!imagemAntiga.isEmpty()) bicla.setFoto(imagemAntiga);
      bicla.setNova(nova);
      bicla.setCat(cat);
      bicla.setEstado(estado);
      bicla.setMatricula(idBic);
      System.out.println("TESTEnome:" + nome + " preco:" + preco + " idCat:" + idCat + "imagem:" + imagem + 
          "idBic: " + idBic);
      bikeDAO.update(bicla);
